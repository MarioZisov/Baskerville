namespace Baskerville.Data.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<BaskervilleContext>
    {
        ...
        {
            //var spiritDrinks = context.ProductsCategories.Find(8);

            //var vodka = new ProductCategory
            //{
            //    IsPrimary = false,
            //    IsRemoved = false,
            //    NameBg = "Водка",
            ...
            //var wiskey = new ProductCategory
            //{
            //    IsPrimary = false,
            //    IsRemoved = false,
            //    NameBg = "Уиски",
            ...
            //vodka.Products.Add(context.Products.Find(7));
            //vodka.Products.Add(context.Products.Find(8));
            //wiskey.Products.Add(context.Products.Find(5));
            //wiskey.Products.Add(context.Products.Find(6));

            //spiritDrinks.SubCategories.Add(vodka);
            //spiritDrinks.SubCategories.Add(wiskey);
            ...
            //        spiritDrinks.Products.Add(wiskey1);
            //        spiritDrinks.Products.Add(wiskey2);
            //        spiritDrinks.Products.Add(vodka1);
            //        spiritDrinks.Products.Add(vodka2);
            //        #endregion
